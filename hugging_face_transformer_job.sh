...
#SBATCH --job-name=v100-train-code-hugging-face         # Job name
#SBATCH --output=v100-train-code-transformer-hugging-face.out      # Standard output log file (%j expands to job ID)
#SBATCH --error=v100-train-code-transformer-hugging-face.err       # Standard error log file (%j expands to job ID)
...
python3 -m hugging_face_transformer.train_linear_head
