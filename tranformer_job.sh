...
#SBATCH --output=v100-train-code-transformer.out      # Standard output log file (%j expands to job ID)
#SBATCH --error=v100-train-code-transformer.err       # Standard error log file (%j expands to job ID)
