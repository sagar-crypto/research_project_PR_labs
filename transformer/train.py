...
from transformer.ploting_util import plot_reconstruction
...
def main(
    ...
    for meas in MEASUREMENTS:
        ...
        CKPT_DIR = os.path.join(CHECKPOINT_TRANSFORMERS_DIR, meas_name)
        ...
        for epoch in range(start_epoch, num_epochs + 1):
            ...
            if epoch % 10 == 0:
                ...
                print(f"  Saved denormalized plot to {plot_path}")

        best_path = os.path.join(CKPT_DIR, f"best_model_{best_epoch:02d}.pth")
