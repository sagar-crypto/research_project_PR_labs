...
#SBATCH --output=v100-train-code-result.out      # Standard output log file (%j expands to job ID)
#SBATCH --error=v100-train-code-result.err       # Standard error log file (%j expands to job ID)
