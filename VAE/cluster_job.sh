...
python 6_clusters.py \
  --latent_dir /home/hpc/iwi5/iwi5305h/research_project_PR_labs/ \
  --measurements \
  ...
  --min_cluster_size 5 \
  --output_png /home/hpc/iwi5/iwi5305h/research_project_PR_labs/clustering_img/
